...
import com.example.xiangnanzhang.myapplication.Medals.DragLinearLayout;
import com.example.xiangnanzhang.myapplication.Medals.ZoomOutPageTransformer;
...
public class MedalsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activtiy_medals);
